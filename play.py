...
def multi_play(policy_model_name: str, opponent_model_name: str, round_: int, n: int):
    policy = load_model(f"/home/wlog/Desktop/Abalone_setup_generator/{policy_model_name}.pth", n)
    opponent = load_model(f"/home/wlog/Desktop/Abalone_setup_generator/{opponent_model_name}.pth", n)
    round = round_
    policy_wins = 0
    opponent_wins = 0
...
multi_play("model/policy_99", "model/policyNetwork_pretrain", 100, 5)
